...
namespace dev_ops_project.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        {
            var appDbContext = _context.Transactions.Include(t => t.Category).Include(t => t.User);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Amount,Date,Description,CategoryId,UserId,Type")] Transaction transaction)
        {
